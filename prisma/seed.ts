...
const starterPosts: Array<{
  ...
  {
    groupSlug: "exam-track",
    title: "هدف الامتحان هذا الشهر",
    body: "اكتب: أي امتحان؟ (IELTS / TOEFL / TOEIC / PTE) ومتى تقريبًا؟ وما المهارة الأضعف عندك الآن؟ سنساعدك بخطة بسيطة.",
  },
  {
    groupSlug: "career-english",
    title: "تمرين: بريد إلكتروني قصير للعمل",
    body: "اكتب 4–6 جمل بالإنجليزية: طلب اجتماع، أو تحديث مشروع، أو اعتذار مهذب عن تأخير. الصق المسودة هنا وسنراجع الوضوح والنبرة.",
  },
];
